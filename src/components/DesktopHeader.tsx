...
import { Coffee, Shield, Terminal, Smartphone, Download, HardDrive, Cloud } from 'lucide-react';
    ...
    <header className="border-b border-slate-800 bg-slate-900/90 backdrop-blur sticky top-0 z-30">
      ...
      <div className="flex items-center justify-between px-4 py-2 bg-slate-950 border-b border-slate-800/80 text-xs select-none">
        ...
        <div className="flex items-center gap-3 text-slate-400 font-mono text-[11px]">
          ...
          >
            Author: <span className="text-amber-300 font-semibold underline decoration-dotted">Khan Mohammed Kaif</span>
          </button>
